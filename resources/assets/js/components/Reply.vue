            ...
            <div class="flex-1 ml-1">
                <div class="flex items-center mb-6 mt-2">
                    <div class="flex flex-1">
                        ...
                        <a v-if="! editing && (authorize('owns', reply) || authorize('owns', reply.issue))"
                           href="#"
                    ...
                    <div class="text-2xs flex items-center">
                        <a v-if="authorize('owns', reply.issue) || isBest" href="#" class="mr-2 font-bold flex items-center" :class="bestReplyClasses" @click.prevent="markBestReply">
    ...
    export default {
        ...
        computed: {
            ...
            bestReplyClasses() {
                ...
                if (!this.authorize("owns", this.reply.issue)) {
